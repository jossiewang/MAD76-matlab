...
% car 00%% Global Variables (required by mbc_car_display)
global P_p_l P_p_frontaxle_1 P_p_rearaxle_1 P_p_rear_1 P_p_c_1 P_p_c_2 P_p_delta_max P_p_psi0 P_p_s10 P_p_s20
...
P_p_kd1 = 0.15; % disturbance const. cornering resistance [ ] the
P_p_k = 3.4; % gain [ m/s ]
P_p_T = 120e-3; % time constant [ s ]
P_p_uTt = 100e-3; % input dead time [ s ] 
P_p_un_max = 0.2; % maximum motor input signal [ 1 ] 
...
P_p_xvec3 = [ P_p_v0; P_p_s13; P_p_s23; P_p_psi3; 0; 0; 0 ];%% Global Variables (required by mbc_car_display)
global P_p_l P_p_frontaxle_1 P_p_rearaxle_1 P_p_rear_1 P_p_c_1 P_p_c_2 P_p_delta_max P_p_psi0 P_p_s10 P_p_s20

...
function [c, ceq] = mpc_constraints(u, state, N, spline,dt,...
    ...
    for k = 1:N
        ...
        if apply_constraints
            ...
            c = [c;
                 ...
                 double(x_diff(2) - psi_max);    % theta <= theta_max -> x(3) - theta_max <= 0
                 double(psi_min - x_diff(2));   % theta >= theta_min -> theta_min - x(3) <= 0  
                ];
        end
    end
end